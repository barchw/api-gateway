...
type APIRuleStatus struct {
	...
	APIRuleStatus        *APIRuleResourceStatus2 `json:"APIRuleStatus,omitempty"`
	VirtualServiceStatus *APIRuleResourceStatus2 `json:"virtualServiceStatus,omitempty"`
	AccessRuleStatus     *APIRuleResourceStatus2 `json:"accessRuleStatus,omitempty"`
}

//APIRule is the Schema for the apis ApiRul
...
//APIRuleResourceStatus2 .
type APIRuleResourceStatus2 struct {
